...
mathlea <- get_data("EDFacts_math_achievement_lea_2010_2019")

rlalea <- get_data("EDFacts_rla_achievement_lea_2010_2019")

skim(mathlea)
skim(rlalea)

mathlea %>% tabyl(ECD_MTHHSPCTPROF)
mathlea %>% tabyl(LEP_MTHHSPCTPROF)
mathlea %>% tabyl(HOM_MTHHSPCTPROF)
mathlea %>% tabyl(MIG_MTHHSPCTPROF)
mathlea %>% tabyl(CWD_MTHHSPCTPROF)
